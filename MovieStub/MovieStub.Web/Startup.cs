...
using MovieStub.Repository.Implementation;
...
namespace MovieStub.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<MovieStubAppUser>(options => options.SignIn.RequireConfirmedAccount = true)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            else
            {
                ...
                // The default HSTS value is 30 days. You may want to change this for Movieion scenarios, see https://aka.ms/aspnetcore-hsts.
                app.UseHsts();
            }
