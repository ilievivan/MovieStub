...
namespace MovieStub.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<MovieStubAppUser> signInManager;
        public AccountController(UserManager<MovieStubAppUser> userManager, SignInManager<MovieStubAppUser> signInManager)
        {
